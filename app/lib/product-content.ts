...
export function getPremiumFallbackDescription(product: Product): string[] {
  return [
    ...
    `Desenvolvida para o dia a dia com estética contemporânea, esta peça traduz o DNA da Papirar: minimalismo sofisticado, materiais selecionados e caimento impecável.`,
