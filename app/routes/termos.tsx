...
export default function TermosRoute() {
  return (
    <StorefrontShell>
      <LegalPage
        title="Termos de Serviço"
        intro="Ao utilizar o site da ROUHI, você concorda com os termos abaixo. Leia com atenção antes de realizar compras ou criar conta."
        sections={[
          {
            title: "1. Sobre a loja",
            paragraphs: [
              "A ROUHI opera como loja online de moda e lifestyle. Produtos, preços, estoque e promoções podem ser alterados sem aviso prévio.",
            ],
          },
          {
          ...
          },
          {
            ...
            paragraphs: [
              "Marcas, imagens, textos e layout do site pertencem à ROUHI ou a seus licenciadores. É proibida a reprodução sem autorização.",
            ],
          },
          {
            title: "6. Contato",
            paragraphs: [
              "Dúvidas sobre estes termos: suporte@rouhi.com.br",
